...
class DDR5 : public IDRAM, public Implementation {
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
      ...
      {"DDR5_2400AN",  {6400,  18,  48,  48,   48,  115,  160,   106,   30,  44,  4,   18,    18,     70,   18,    36,    102,  18,   -1,   -1,  -1,   -1,   -1,    -1,     67,    -1,   -1,   -1,     -1,     -1,    6,  1250}},
      {"DDR5_2400BN",  {6400,  18,  52,  52,   52,  115,  164,   106,   30,  48,  4,   18,    18,     73,   18,    36,    106,  18,   -1,   -1,  -1,   -1,   -1,    -1,     67,    -1,   -1,   -1,     -1,     -1,    6,  1250}},
      {"DDR5_2400C",   {6400,  18,  56,  56,   56,  115,  168,   106,   30,  52,  4,   18,    18,     77,   18,    36,   110,  18,   -1,   -1,  -1,   -1,   -1,    -1,     67,    -1,   -1,   -1,     -1,     -1,    6,  1250}},
  ...
  private:
    ...
    void set_timing_vals() {
      ...
      constexpr int nRRDL_TABLE[3][10] = {
        ...
        {18, 16, 14, 12, 11, 10, 9, 9, 8, 8},  // x8
        {18, 16, 14, 12, 11, 10, 9, 9, 8, 8}   // x16
      };
      constexpr int nFAW_TABLE[3][10] = {
      // 2400   3200  3600 4000 4400 4800 5200 5600 6000 6400
        { 90,   80, 71, 64, 58, 53, 49, 45, 42, 40},  // x4
        { 72,   64, 56, 51, 46, 42, 39, 36, 34, 32},  // x8
        { 72,   64, 56, 51, 46, 42, 39, 36, 34, 32}   // x16
      };
